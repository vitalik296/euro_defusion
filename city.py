class City(object):
    ...
    def get_neighbors(self):
        self.link((self.__point.x, self.__point.y + 1))
        self.link((self.__point.x + 1, self.__point.y))
        self.link((self.__point.x, self.__point.y - 1))
        self.link((self.__point.x - 1, self.__point.y))
    ...
    def link(self, coords):
        neighbor = self._city_cash[self.__world_id].get(coords, None)
        if neighbor:
